...
public class GenericRecipeBuilder {
    ...
    public GenericRecipeBuilder(final Supplier<? extends RecipeSerializer<GenericRecipe>> serializer, final ItemStack stack) {
    ...
    public GenericRecipeBuilder withIngredient(final char key, final List<TagKey<Item>> tags) {
        return this.withIngredient(key, new BasicRegularIngredient(LazyMultiTagIngredient.of(tags)));
    }
