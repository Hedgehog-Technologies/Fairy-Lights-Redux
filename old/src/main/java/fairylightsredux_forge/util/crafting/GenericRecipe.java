...
public final class GenericRecipe extends CustomRecipe {
    ...
    public GenericRecipe(final Supplier<? extends RecipeSerializer<GenericRecipe>> serializer, final ItemStack output, final RegularIngredient[] ingredients, final AuxiliaryIngredient<?>[] auxiliaryIngredients, final int width, final int height, final int outputIngredient) {
    ...
    private List<Ingredient> getDisplayIngredients() {
...
//    }
    ...
    // @TODO - recipe rework
    @Override
    public boolean matches(@NonNull CraftingInput input, @NonNull Level world) {
        throw new NotImplementedException("GenericRecipe.matches");
    }
...
//        }
    ...
    @Override
    public @NonNull ItemStack assemble(final @NonNull CraftingInput input, final HolderLookup.@NonNull Provider registries) {
