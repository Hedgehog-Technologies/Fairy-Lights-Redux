package org.hedgetech.fairylightsredux.server.sound;
...
public final class FLRSounds {
    public static final DeferredRegister<SoundEvent> REG = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Constants.MOD_ID);
    ...
    private static RegistryObject<SoundEvent> create(final String name) {
        return REG.register(name, () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, name)));
    }
