...
public final class PlayerFastener extends EntityFastener<Player> {
    ...
    public Vec3 getConnectionPoint() {
        ...
        if (this.entity.isFallFlying()) return point;
        final double angle = (this.entity.yBodyRot - 90) * FLRMth.DEG_TO_RAD;
    ...
    public void resistSnap(final Vec3 from) {
        ...
        if (dist > Connection.MAX_LENGTH) {
            ...
            if (this.entity instanceof ServerPlayer sp) {
                sp.connection.send(new ClientboundSetEntityMotionPacket(this.entity));
            }
        }
    }
