...
public class HeartLightModel extends ColorLightModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        bulb.setUV(66, 38).addBox(3.0F, 1.0F, -1.0F, 3.0F, 3.0F, 2.0F);
        bulb.setUV(66, 38 + 5).addBox(3.02F, 3.98F, -1.0F, 3.0F, 2.0F, 2.0F, -0.02F, 0.65F);
        bulb.setUV(66 + 10, 38).addBox(1.02F, 0.98F, -1.0F, 2.0F, 3.0F, 2.0F, -0.02F, 0.65F);
