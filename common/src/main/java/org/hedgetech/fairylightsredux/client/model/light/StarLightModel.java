...
public class StarLightModel extends ColorLightModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        helper.unlit().setTextureOffset(u + 12, v).addBox(-0.5F, 5.0F-7.0f, -0.5F, 1.0F, 3.0F, 1.0F);
