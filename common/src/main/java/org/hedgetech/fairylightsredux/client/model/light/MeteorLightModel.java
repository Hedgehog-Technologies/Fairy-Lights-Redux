...
import org.hedgetech.fairylightsredux.server.feature.light.MeteorLightBehavior;
...
public class MeteorLightModel extends LightModel<MeteorLightBehavior> {
    ...
    public static LayerDefinition createLayer() {
        ...
        for (int i = 0; i < LIGHT_COUNT; i++) {
            ...
            light.addBox(-1, -i * 2 - 2.5F + 0.05F, -1, 2, 2, 2, Mth.sin(i * FLRMth.PI / LIGHT_COUNT) * 0.1F);
        }
        return helper.build();
    }
