...
public class SkullLightModel extends ColorLightModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        apertures.xRot = FLRMth.PI;
        apertures.yRot = FLRMth.PI;
