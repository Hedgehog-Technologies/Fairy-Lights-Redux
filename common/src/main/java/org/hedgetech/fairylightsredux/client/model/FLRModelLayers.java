package org.hedgetech.fairylightsredux.client.model;

import net.minecraft.client.model.geom.ModelLayerLocation;
import net.minecraft.resources.ResourceLocation;
import org.hedgetech.fairylightsredux.Constants;

public class FLRModelLayers {
    ...
    private static ModelLayerLocation layer(String name, String layer) {
        return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, name), layer);
    }

    private FLRModelLayers() {}
}
