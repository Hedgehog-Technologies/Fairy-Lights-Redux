...
import org.hedgetech.fairylightsredux.server.feature.light.*;
...
public class SimpleLightVariant<T extends LightBehavior> implements LightVariant<T> {
    ...
    // TECH_DEBT - What the hell is this about?
//    @Override
    ...
    @Override
    public LightVariantType<?> type() {
        // FIXME - get actual LightVariantType
        return null;
    }
